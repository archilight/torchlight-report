...
import com.torchlight.report.preferences.ITorchlightPreferenceConstants;
...
public class TorchLightPlugin extends AbstractUIPlugin {
    ...
    public static final String PLUGIN_ID = "com.torchlight.report"; //$NON-NLS-1$
   ...
   public void setReportFile(File f)
   {
    ...
    public File getDefaultUserTempFolder() {
        File folder = new File(Preferences.STORE.getString(IPreferenceConstants.USER_DATA_FOLDER), "torchlight-reports"); //$NON-NLS-1$
        if (!folder.exists())
        	folder.mkdirs();
        return folder;
    }
    ...
    public File getDefaultUserReportsFolder() {
        File folder = new File(Preferences.STORE.getString(IPreferenceConstants.USER_DATA_FOLDER), "torchlight-reports"); 
    	folder.mkdirs();
